...
class atkStructure:
    def __init__(self):
        ...
        self.add('build', [[24, 13]], [[23, 13], [0, 13], [22, 13], [25, 13], [1, 12], [2, 11], [3, 10], [4, 9], [5, 8], [6, 7], [7, 6], [8, 5], [9, 4], [15, 4], [10, 3], [14, 3], [11, 2], [13, 2], [12, 1]],[[24, 12], [23, 11], [22, 10], [21, 9], [20, 8], [19, 7], [18, 6], [17, 5], [16, 4]])

        self.add('build', [[12, 7]], [], [])
        self.add('upgrade', [[12, 7]], [], [])

        self.add('upgrade', [[24, 13]], [], [])

        self.add('upgrade', [], [], [[24, 12], [23, 11], [22, 10], [21, 9], [20, 8], [19, 7], [18, 6], [17, 5], [16, 4], [22, 11], [22, 12], [23, 12]])
        self.add('build', [], [], [[22, 11], [22, 12], [23, 12]])
        self.add('upgrade', [], [], [[22, 11], [22, 12], [23, 12]])
...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def check_attack_right_corner(self, game_state):
        ...
        if self.ds.all_SP(game_state) < 65:
            return False
    ...
    def attack_right_corner(self, game_state):
        ...
        self.stall_with_demolisher(game_state, 100, True)
